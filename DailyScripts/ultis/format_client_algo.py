...
haitongcredit_rzmr_df = pd.read_csv(r'E:\code\DailyScripts\SplitSystemData\rzrq\haitongcredit_rzmr.csv', encoding='gbk')
...
haitongcredit_danbaopin_df = pd.read_csv(r'E:\code\DailyScripts\SplitSystemData\rzrq\haitongcredit_danbaopin.csv', encoding='gbk')
...
def format_adj_algo(mo_path, data, date, adj_client, adj_acct, adj_algo, acct, adj_algo_starttime, adj_algo_endtime, rzrq=False, algo_type='adj'):
    ...
    mo_path = f'{mo_path}/mo_order/{date}'
