...
haitongcredit_rzmr_df = pd.read_csv(r'D:\code\generate_split_system\data\raw\rzrq\haitongcredit_rzmr.csv', encoding='gbk')
...
haitongcredit_danbaopin_df = pd.read_csv(r'D:\code\generate_split_system\data\raw\rzrq\haitongcredit_danbaopin.csv', encoding='gbk')
